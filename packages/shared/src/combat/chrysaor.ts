...
import { coordKey, isObstacleTile, tileAt } from "../map.js";
import { applyDamageToEnemy, applyDamageToObstacle, applyDamageToPlayer } from "./attack.js";
import { rollDice } from "./damage.js";
import { applyEffectStacks, applyTileEffectStacks, removeEffectStacks } from "./effects.js";
import type { BrandStripCandidate, BrandStripReaction } from "./types.js";
...
export function applySoulBranding(
  ...
  if (target.kind === "enemy") {
    ...
    applyEffectStacks(enemy, [`${BRAND_EFFECT}:2`]);
