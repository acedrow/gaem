...
import { buildSwarmGroups, reconcileSwarmHp, swarmGroupForEnemy } from "./swarm.js";
...
import { applySwarmMemberForcedMove } from "./swarm.js";
...
function isEnemyPullDestinationValid(
  ...
  for (const tile of enemyFootprintTiles(anchorX, anchorY, scale)) {
    ...
    if (enemy && enemy.id !== enemyId) return false;
  }
  return true;
}
